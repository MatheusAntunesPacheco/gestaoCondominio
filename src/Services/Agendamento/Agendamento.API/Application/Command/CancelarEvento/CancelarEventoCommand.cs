...
namespace Agendamento.API.Application.Command.CancelarEvento
{
    ...
    public class CancelarEventoCommand : IRequest<ProcessamentoBaseResponse>
    {
        ...
        public CancelarEventoCommand(string cpf, int idCondominio, int idAreaCondominio, DateTime dataEvento, string cpfUsuarioLogado, bool usuarioAdministradorCondominio, bool usuarioComumCondominio)
        {
            Cpf = cpf;
