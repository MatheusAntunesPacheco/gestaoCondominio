...
{
    public class AgendamentoEventoRequest
    {
        /// <summary>
        /// CPF do usuario
        /// </summary>
        ...
        public AgendamentoEventoRequest(string cpf, int idCondominio, int idAreaCondominio, DateTime dataEvento, string cpfUsuarioLogado, bool usuarioAdministradorCondominio, bool usuarioComumCondominio)
        {
            Cpf = cpf;
